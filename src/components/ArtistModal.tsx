  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-5xl bg-[#0F1117] sm:border border-white/15 shadow-2xl flex flex-col h-[100dvh] sm:h-auto sm:max-h-[92dvh] overflow-hidden"
      >
        {/* Header Action Bar */}
        <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-3.5 border-b border-white/10 bg-[#0B0C10] shrink-0 pt-[calc(0.75rem+env(safe-area-inset-top,0px))] sm:pt-3.5 z-10">
          <button
            type="button"
        ...
        {/* Modal Single Unified Scroll Area */}
        <div
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 min-h-full">
            ...
            {/* Right Column: Detailed Actor Bio & Specs & Filmography (Single Seamless Flow) */}
            <div className="lg:col-span-7 p-6 sm:p-8 flex flex-col justify-between">
              <div className="space-y-6">
                {/* 1. Name & Titles & Instagram */}
                ...
                {/* 3. Basic Specifications (Birth, Height, Gender, Education) */}
                ...
                {/* 4. FILMOGRAPHY: Directly flows right after basic info! */}
                <div className="pt-6 border-t border-white/10 space-y-4">
                  ...
                  {artist.filmography && artist.filmography.length > 0 ? (
                    ...
                    <div className="text-center py-8 text-xs text-gray-500 font-mono bg-[#131620] border border-white/5">
                      현재 등록된 필모그래피가 없습니다.
                    </div>
                  )}
                </div>

                {/* 5. Showreel / Video Feature (if available) */}
                {validEmbedUrl && (
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <h4 className="text-xs sm:text-sm font-bold text-white">
                            {artist.nameKo} 배우 공식 쇼릴 (SHOWREEL)
                          </h4>
              ...
              <div className="mt-8 pt-6 border-t border-white/10 flex flex-wrap items-center justify-between gap-3 bg-[#0B0C10] -mx-6 -mb-6 sm:-mx-8 sm:-mb-8 p-5 sm:p-6 pb-[calc(1.5rem+env(safe-area-inset-bottom,0px))]">
                {/* PDF Profile Download Button */}
                <button
